...
import { NO_GAME_IN_PROGRESS_ERROR } from './Connect4AreaController';
import Connect4BotAreaController from './Connect4BotAreaController';

describe('[T1] Connect4BotAreaController', () => {
  ...
  const botPlayer = new PlayerController('Connect4Bot', 'Bot', {
    x: 0,
    y: 0,
    moving: false,
    rotation: 'front',
  ...
  function connect4BotAreaControllerWithProp({
    _id,
    history,
    yellow,
    red,
    ...
    const ret = new Connect4BotAreaController(
      id,
      {
        id,
        occupants: players,
  ...
  describe('[T1.1]', () => {
    describe('isActive', () => {
      it('should return true if the game is in progress', () => {
        const controller = connect4BotAreaControllerWithProp({
          status: 'IN_PROGRESS',
        });
    ...
    describe('whoseTurn', () => {
      ...
      it('should return the player whose turn it is after a move', () => {
        ...
        expect(controller.whoseTurn).toStrictEqual(botPlayer);
      });
    ...
    describe('red', () => {
      it('should return the red player if there is one', () => {
        ...
        expect(controller.red).toStrictEqual(botPlayer);
      });
  ...
  describe('[T1.2] _updateFrom', () => {
    describe('if the game is in progress', () => {
      let controller: Connect4BotAreaController;
      beforeEach(() => {
        controller = connect4BotAreaControllerWithProp({
          status: 'IN_PROGRESS',
          yellow: ourPlayer.id,
          red: otherPlayers[0].id,
        });
